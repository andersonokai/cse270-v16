...
class TestSmokeTest():
  ...
  def test_navigatetothehomepage(self):
    ...
    self.driver.set_window_size(1263, 765)
  ...
  def test_navigatetotheadminpage(self):
    self.driver.get("http://127.0.0.1:5500/cse270/teton/1.6/admin.html")
    self.driver.set_window_size(1376, 784)
    self.driver.find_element(By.ID, "username").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("Anderspn")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("Yahoo345")
  ...
  def test_navigatetothedirectorypage(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".gold-member:nth-child(9) > p:nth-child(2)").text == "Teton Turf and Tree"
    self.driver.set_window_size(1334, 775)
  
  def test_navigatetothehomepage2(self):
    self.driver.get("http://127.0.0.1:5500/cse270/teton/1.6/index.html")
    self.driver.set_window_size(1355, 769)
  ...
  def test_navigatetothejoinpage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Anderson")
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Okai")
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Newwork")
    self.driver.find_element(By.NAME, "submit").click()
